...
public class CreateData {
    ...
    private static void addAccounts(){
        ...
        try{
            oldMaster = new ObjectOutputStream(Files.newOutputStream(Paths.get("src/filematchingserialization/oldmast.ser"))); //Create/Open a new/existing file
        }
    ...
    private static void addTransactions(){
        ...
        try{
            inTransaction = new ObjectOutputStream(Files.newOutputStream(Paths.get("src/filematchingserialization/intrans.ser")));
        }
        catch(SecurityException e){
            System.err.println("Write permission denied.");
            System.exit(1);
